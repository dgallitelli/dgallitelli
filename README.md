...
- [Asia Deck Builder Assistant](https://github.com/dgallitelli/asia-pokemon-card-deck-builder-assistant) — import Limitless/PTCGL deck lists into the official regional deck builder.
...
- [skillsops](https://github.com/dgallitelli/skillsops) — governance tooling for agent skills.
- [autoresearchctl](https://github.com/dgallitelli/autoresearchctl) — autonomous optimization loops for arbitrary codebases.
- [Latent Thoughts](https://dgallitelli.github.io/blog/) — research notes and technical writing.
